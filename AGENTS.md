...
| **bbot** | **`claude-cli/claude-opus-4-7`** | `workspace-bbot/` | **off** | **✓** (2026-05-16 추가) | `@glg_b_bot`. **2026-05-29 pi-shell-acp → claude-cli native 전환** (third-party harness extra-usage 빈응답 탈출, Max 한도 인식). 카탈로그에 `claude-cli/claude-opus-4-8`(검증됨)·`pi-shell-acp/claude-opus-4-7`(reversibility) 보존 |
