...

{
  programs.autorandr = {
    ...
    profiles = {
      ...
      # ThinkPad + Lenovo P24q-20 QHD (HDMI 듀얼: QHD 위 + 노트북 아래) - 집
      "thinkpad-home-qhd" = {
        fingerprint = {
          eDP-1 = "";
          HDMI-1 = "";
        };
        config = {
          HDMI-1 = {
            enable = true;
          ...
          eDP-1 = {
            enable = true;
            primary = true;
            position = "320x1440";  # 아래, 가로 센터 (2560-1920)/2
            mode = "1920x1200";
            rate = "60.00";
          };
        };
